class ThemeSelector extends HTMLElement {
  constructor() {
    ...
    this.shadowRoot
      ...
      .addEventListener("change", this.changeTheme.bind(this));
  }

  async connectedCallback() {
    // Append colorblind filters to the main document
    document.body.appendChild(this.createColorBlindFilters());
    this.shadowRoot.querySelector("#theme-select").value = "normal";
  ...
  buildTemplate() {
    ...
    const options = [
      ...
      { value: "", text: "👁️ Color Blind Types 👁️", disabled: true },
